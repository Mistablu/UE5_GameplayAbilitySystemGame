...
//create FEffectProperties struct
USTRUCT()
...
public:
	...
	*/
	...
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_StatusResistance, Category = "Secondary Attributes")
	FGameplayAttributeData StatusResistance;
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet, StatusResistance);
	...
	*/
	...
	UFUNCTION()
	void OnRep_StatusResistance(const FGameplayAttributeData& OldStatusResistance) const;
	UFUNCTION()
